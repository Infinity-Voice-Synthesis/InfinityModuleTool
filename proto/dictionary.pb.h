...
PROTOBUF_NAMESPACE_OPEN
template<> ::infinity::module::dictionary::Dictionary* Arena::CreateMaybeMessage<::infinity::module::dictionary::Dictionary>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace infinity {
namespace module {
namespace dictionary {
...
class Dictionary final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:infinity.module.dictionary.Dictionary) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "infinity.module.dictionary.Dictionary";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:infinity.module.dictionary.Dictionary)
 private:
  class _Internal;
...
// double IMT_Version = 1;
inline void Dictionary::clear_imt_version() {
  imt_version_ = 0;
}
inline double Dictionary::_internal_imt_version() const {
  return imt_version_;
}
inline double Dictionary::imt_version() const {
  // @@protoc_insertion_point(field_get:infinity.module.dictionary.Dictionary.IMT_Version)
  return _internal_imt_version();
}
inline void Dictionary::_internal_set_imt_version(double value) {
  
  imt_version_ = value;
}
inline void Dictionary::set_imt_version(double value) {
  _internal_set_imt_version(value);
  // @@protoc_insertion_point(field_set:infinity.module.dictionary.Dictionary.IMT_Version)
}

// string name = 2;
inline void Dictionary::clear_name() {
  name_.ClearToEmpty();
}
inline const std::string& Dictionary::name() const {
  // @@protoc_insertion_point(field_get:infinity.module.dictionary.Dictionary.name)
  return _internal_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Dictionary::set_name(ArgT0&& arg0, ArgT... args) {
 
 name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:infinity.module.dictionary.Dictionary.name)
}
inline std::string* Dictionary::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:infinity.module.dictionary.Dictionary.name)
  return _s;
}
inline const std::string& Dictionary::_internal_name() const {
  return name_.Get();
}
inline void Dictionary::_internal_set_name(const std::string& value) {
  
  name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Dictionary::_internal_mutable_name() {
  
  return name_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Dictionary::release_name() {
  // @@protoc_insertion_point(field_release:infinity.module.dictionary.Dictionary.name)
  return name_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void Dictionary::set_allocated_name(std::string* name) {
  if (name != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:infinity.module.dictionary.Dictionary.name)
}
